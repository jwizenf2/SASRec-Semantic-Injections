...
Usage:
    uv run python sailrec/scripts/summarize_convergence.py
"""
...
OUTPUTS = Path("sailrec/outputs")

RUNS = {
    "SASRec (VG)":        OUTPUTS / "p1_video_games",
    "SAILS (VG)":         OUTPUTS / "sailrec_video_games",
    ...
    "SAILS (Sports18)":   OUTPUTS / "sailrec_sports2018",
