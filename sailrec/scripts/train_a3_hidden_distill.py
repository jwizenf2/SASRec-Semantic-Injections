...
from sailrec.training.hidden_distill_trainer import HiddenStateDistillTrainer
...
def main():
    ...
    parser.add_argument("--config", default="sailrec/configs/ablations/A3_hidden_distill.yaml")
