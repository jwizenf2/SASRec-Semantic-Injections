...
Per checkpoint::
    ...
    sailrec/outputs/<run_dir>/seed_<S>/stratified_fullrank.json

Aggregate (mean ± std across seeds, written next to the existing
``aggregate_fullrank_results.json``)::

    sailrec/outputs/<run_dir>/aggregate_stratified_fullrank.json
...
::
    ...
    uv run python sailrec/scripts/eval_stratified.py \\
        --config sailrec/configs/p1_video_games.yaml --seeds 42 7 18

    uv run python sailrec/scripts/eval_stratified.py \\
        --config sailrec/configs/ablations/A1_llm_init.yaml --seeds 42 7 18

    uv run python sailrec/scripts/eval_stratified.py \\
        --config sailrec/configs/sailrec_video_games.yaml --seeds 42 7 18
"""
