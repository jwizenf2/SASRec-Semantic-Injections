"""SAILRecTrainer — SASRec + auxiliary InfoNCE alignment.

Trainer for the SAILRec method. Subclasses :class:`BaseTrainer` and
adds:
...
class SAILRecTrainer(BaseTrainer):
    ...
    def _summary_config(self) -> dict[str, Any]:
        """Add SAILRec-specific knobs to the train_summary.json config."""
    ...
    # early-stopping bookkeeping. SAILRec also owns a trainable
