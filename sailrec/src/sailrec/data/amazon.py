...
Counterpart to :mod:`sailrec.data.movielens` for the standard LLM4Rec
...
apples-to-apples with 2018-Beauty papers, but our internal P1 → SAILRec
...
* :func:`load_ratings`  — DataFrame with the four canonical columns
                          ...
                          ready for :func:`sailrec.data.movielens.preprocess`.
* :func:`load_metadata` — DataFrame with
                          ``[item_id, title, description]``, used by
                          :class:`sailrec.data.item_metadata.ItemMetadata`
...
# papers. SAILRec's headline experiment uses Video_Games instead — see
# `sailrec/configs/sailrec_video_games.yaml`.
