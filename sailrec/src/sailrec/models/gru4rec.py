...
interface exported by :class:`sailrec.models.sasrec.SASRec` so it can be
dropped into every existing trainer, eval script, and ablation (A1 LLM-init,
A8 SAILRec) without modification.
...
identical to :class:`sailrec.training.trainer.SASRecTrainer`.
