...
from train_baseline import log, prepare_data
...
def main():
    ...
    parser.add_argument("--config", default="sasrec_injection/configs/ablations/A2_input_fusion.yaml")
    ...
    llm_path = raw.get("llm_embeddings_path", "sasrec_injection/outputs/embeddings/video_games.pt")
