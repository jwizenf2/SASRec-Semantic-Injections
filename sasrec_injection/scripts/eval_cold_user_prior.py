...
For each input config, writes per-α stratified metrics::
    ...
    sasrec_injection/outputs/<run_dir>/cold_user_prior_results.json
...
::
    ...
    uv run python sasrec_injection/scripts/eval_cold_user_prior.py \\
        --config sasrec_injection/configs/p1_video_games.yaml \\
        --llm-embeddings sasrec_injection/outputs/embeddings/video_games.pt \\
        --seeds 42 7 18 \\
