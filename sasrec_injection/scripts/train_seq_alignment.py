...
from sasrec_injection.training.seq_infonce_trainer import SeqInfoNCETrainer
...
def main():
    ...
    parser.add_argument("--config", default="sasrec_injection/configs/ablations/A4_seq_infonce.yaml")
