...
:func:`sasrec_injection.data.movielens.preprocess` so titles and behavioural
data align.
"""
...
from sasrec_injection.data.movielens import load_movies
...
class ItemMetadata:
    ...
    def from_movielens(
        ...
        Args:
            ...
            item_map: Original int item id → remapped int item id.
                Output of
                :func:`sasrec_injection.data.movielens.preprocess`.
    ...
    def from_amazon(
        ...
        # MovieLens runs.
        from sasrec_injection.data.amazon import load_metadata as _amazon_load_metadata
    ...
    def from_yelp(
        ...
        # for unrelated runs.
        from sasrec_injection.data.yelp import load_metadata as _yelp_load_metadata
    ...
    def from_dataset(
        ...
        Convention matches :mod:`sasrec_injection.data.loaders`:
